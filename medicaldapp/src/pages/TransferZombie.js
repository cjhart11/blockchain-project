...
class TransferZombie extends Component {
  ...
  onSubmit = async event => {
    ...
    try {
      ...
      this.setState({
        loading: false,
        message: "Yay!!!!  I have been transferred to a new owner!"
      });
    } catch (err) {
      this.setState({
        loading: false,
  ...
  render() {
    return (
      <div>
        *<Header icon="browser" content="Transfer me to a new owner!!" />
        <table>
          <tr>
            <th>
              <ZombieCard
            ...
            <th>
              <img src="static/images/transferBack.jpg" alt="Transfer" />
            </th>
          </tr>
        </table>
        <br />
